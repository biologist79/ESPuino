...
const char nightVolumeCapSet[] = "Mode nuit : volume temporairement limité à : %u";
...
const char announcementPlaying[] = "Lecture de l'annonce : %s";
const char announcementFinished[] = "Annonce terminee, reprise de la lecture";
const char announcementFileMissing[] = "Fichier d'annonce introuvable, la lecture continue sans changement : %s";
const char announcementFailed[] = "Impossible de lire l'annonce, reprise de la lecture : %s";
const char announcementTimeout[] = "L'annonce ne s'est pas terminee, restauration de la lecture";
...
const char webSaveSettingsVolumeMinMaxError[] = "Le volume minimum doit être inférieur aux deux volumes maximum.";
