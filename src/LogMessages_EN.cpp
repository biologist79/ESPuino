...
const char nightVolumeCapSet[] = "Night mode: volume temporarily limited to: %u";
...
const char announcementPlaying[] = "Playing announcement: %s";
const char announcementFinished[] = "Announcement done, resuming playback";
const char announcementFileMissing[] = "Announcement file not found, playback continues untouched: %s";
const char announcementFailed[] = "Announcement could not be played, resuming playback: %s";
const char announcementTimeout[] = "Announcement did not finish, restoring playback";
...
const char webSaveSettingsVolumeMinMaxError[] = "Minimum volume must be lower than both maximum volumes.";
