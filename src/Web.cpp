...
static void settingsToJSON(JsonObject obj, const String section) {
	...
	if ((section == "") || (section == "general")) {
		...
		generalObj["resumeOnSameRfid"].set(gPrefsSettings.getBool("p2pSameRfid", false)); // Resume playback when same RFID is applied again
	...
	if (section == "defaults") {
		...
		genSettings["resumeOnSameRfid"].set(false); // Resume playback when same RFID is applied again
