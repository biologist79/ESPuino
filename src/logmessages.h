...
extern const char announcementPlaying[];
extern const char announcementFinished[];
extern const char announcementFileMissing[];
extern const char announcementFailed[];
extern const char announcementTimeout[];
