// clang-format off
	...
	*/
	...
	//#define RESUME_PLAY_ON_SAME_RFID      // If playback is paused and the same RFID-tag is put on again, playback continues. Only useful in combination with DONT_ACCEPT_SAME_RFID_TWICE.
