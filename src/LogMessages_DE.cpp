...
#include "settings.h"
	...
	const char nameOfFileFound[] PROGMEM = "Gefundenes File: %s";
	...
	const char numberOfValidFiles[] PROGMEM = "Anzahl gültiger Files/Webstreams: %u";
	const char newLoudnessReceivedQueue[] PROGMEM = "Neue Lautstärke empfangen via Queue: %u";
	const char newCntrlReceivedQueue[] PROGMEM = "Kontroll-Kommando empfangen via Queue: %u";
	...
	const char trackStartatPos[] PROGMEM = "Titel wird abgespielt ab Position %u";
	...
	const char rfidTagDetected[] PROGMEM = "RFID-Karte erkannt: %s";
	...
	const char dontAccepctSameRfid[] PROGMEM = "Aktuelle RFID-Karte erneut aufgelegt - abgelehnt! (%s)";
	...
	const char modeAllTrackAlphSorted[] PROGMEM = "Modus: Spiele alle Tracks (alphabetisch sortiert) des Ordners '%s'";
	...
	const char initialBrightnessfromNvs[] PROGMEM = "Initiale LED-Helligkeit wurde aus NVS geladen: %u";
	const char wroteInitialBrightnessToNvs[] PROGMEM = "Initiale LED-Helligkeit wurde ins NVS geschrieben.";
	const char restoredInitialBrightnessForNmFromNvs[] PROGMEM = "LED-Helligkeit für Nachtmodus wurde aus NVS geladen: %u";
	...
	const char restoredFtpUserFromNvs[] PROGMEM = "FTP-User wurde aus NVS geladen: %s";
	const char wroteFtpPwdToNvs[] PROGMEM = "FTP-Passwort wurde ins NVS geschrieben.";
	const char restoredFtpPwdFromNvs[] PROGMEM = "FTP-Passwort wurde aus NVS geladen: %s";
	const char restoredMaxInactivityFromNvs[] PROGMEM = "Maximale Inaktivitätszeit wurde aus NVS geladen: %u Minuten";
	const char wroteMaxInactivityToNvs[] PROGMEM = "Maximale Inaktivitätszeit wurde ins NVS geschrieben.";
	const char restoredInitialLoudnessFromNvs[] PROGMEM = "Initiale Lautstärke wurde aus NVS geladen: %u";
	const char wroteInitialLoudnessToNvs[] PROGMEM = "Initiale Lautstärke wurde ins NVS geschrieben.";
	const char restoredMaxLoudnessForSpeakerFromNvs[] PROGMEM = "Maximale Lautstärke für Lautsprecher wurde aus NVS geladen: %u";
	const char restoredMaxLoudnessForHeadphoneFromNvs[] PROGMEM = "Maximale Lautstärke für Kopfhörer wurde aus NVS geladen: %u";
	...
	const char batteryCurrentMsg[] PROGMEM = "Stromverbrauch (Batterie): %.2f mA";
	const char batteryTempMsg[] PROGMEM = "Temperatur der Batterie: %.2f°C";
	const char batteryCyclesMsg[] PROGMEM = "Gesehene Batteriezyklen: %.2f";
	...
	const char warningLowVoltageFromNVS[] PROGMEM = "Spannungslevel (Batterie) fuer Niedrig-Warnung via Neopixel aus NVS geladen: %.2fV";
	const char warningCriticalVoltageFromNVS[] PROGMEM = "Spannungslevel (Batterie) fuer Kritisch-Warnung via Neopixel aus NVS geladen: %.2fV";
	const char batteryLowFromNVS[] PROGMEM = "Batterieladestand fuer Niedrig-Warnung via Neopixel aus NVS geladen: %.2f %%";
	const char batteryCriticalFromNVS[] PROGMEM = "Batterieladestand fuer Kritisch-Warnung via Neopixel aus NVS geladen: %.2f %%";
	...
	const char importCountNokNvs[] PROGMEM = "Anzahl der ungültigen Import-Einträge: %u";
	...
	const char erasePlaylistCachefile[] PROGMEM = "Playlist-Cachefile gelöscht: %s";
	...
	const char sdInfo[] PROGMEM = "SD-Kartengröße / freier Speicherplatz: %llu MB / %llu MB";
