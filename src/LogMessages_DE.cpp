...
const char announcementPlaying[] = "Ansage wird abgespielt: %s";
const char announcementFinished[] = "Ansage beendet, Wiedergabe wird fortgesetzt";
const char announcementFileMissing[] = "Ansage-Datei nicht gefunden, Wiedergabe laeuft unveraendert weiter: %s";
const char announcementFailed[] = "Ansage konnte nicht abgespielt werden, Wiedergabe wird fortgesetzt: %s";
const char announcementTimeout[] = "Ansage wurde nicht beendet, Wiedergabe wird wiederhergestellt";
...
const char webSaveSettingsVolumeMinMaxError[] = "Minimale Lautstärke muss kleiner als beide Maximallautstärken sein.";
